...
#$ -o orthofinder_logs_4
#$ -e orthofinder_logs_4
#
...
/nfs1/MICRO/Thurber_Lab/grace/local_programs/OrthoFinder-2.2.3/orthofinder -f /raid1/home/micro/klingesj/grace/MB599_siderophores/complete_genomes_pseudomonas/faa/split1 -t 22
